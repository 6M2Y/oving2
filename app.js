...
app.get('/api/v1/lists/:listid', (req,res) =>{
...
app.post('/api/v1/lists', (req,res) =>{
    ...
    if(!list.hasOwnProperty('id') ||
        ...
        {
            res.status(400).send('A lsit has to have an id and title properties');
        }
        //if the list already exits
    if(lists.find(i=>t.id == list.id))
    {
...
app.get('/api/v1/lists/:listId/tasks', (req,res) =>{
    const id = req.params.listId;
...
app.get('/api/v1/lists/:listId/tasks/:taskId', (req,res) =>{
...
app.post('/api/v1/lists/:listId/tasks', (req,res) =>{
    const task = req.body;
    //if the list doesnt contain the properties
...
app.delete('/api/v1/lists/:listId/tasks/:taskId',(req,res) =>{
     //variables for taskId and listId
     const listId = req.params.listId;
     const taskId = req.params.taskId;
